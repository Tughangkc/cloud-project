...
public class JwtUtils {
	...
	@Value("${visionrent-docker.app.jwtSecret}") // jwtSecret değerini application.yml dosyasından alıyor
	private String jwtSecret;

	@Value("${visionrent-docker.app.jwtExpirationMs}") // jwtExpirationMs değerini application.yml dosyasından alıyor
