...
import com.app.exception.message.ApiResponseError;
   ...
   private ResponseEntity<Object> buildResponseEntity(ApiResponseError error) {
	...
	protected ResponseEntity<Object> handleResourceNotFoundException ( ResourceNotFoundException ex, WebRequest  request  )   {
			...
			ApiResponseError error =  new ApiResponseError( HttpStatus.NOT_FOUND, 
														    ex.getMessage(), // hangisini set edersek o message gelecek.
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		    ...
		    List<String> errors = ex.getBindingResult().getFieldErrors() // bütün field errorlarını get ile aldım /birden fazla error gelebilir field birden cok.
		    											.stream()
	...
	protected ResponseEntity<Object> handleGeneralException ( Exception ex, WebRequest  request  )   {
		...
		ApiResponseError error =  new ApiResponseError( HttpStatus.INTERNAL_SERVER_ERROR, //genel bir status icin
																								ex.getMessage(), 
																								request.getDescription(false)  );
