...
import com.app.dto.request.ReservationUpdateRequest;
import com.app.dto.response.CarAvailabilityResponse;
...
public class ReservationController {
	...
	public ResponseEntity<VRResponse> checkCarIsAvailable(@RequestParam("carId") Long carId,
		...
		VRResponse response = new CarAvailabilityResponse(ResponseMessage.CAR_AVAILABLE_MESSAGE, true, isAvailable,
				totalPrice);
	...
	// *********** Customer veya Admin kendine ait olan reservasyon bilgilerini
	// getirsin **********************************
	...
	// *********** Customer veya Admin kendine ait olan reservasyon bilgilerini
	// tümünü PAGEABLE olarak getirsin **********************
	@GetMapping("/auth/all")
	@PreAuthorize("hasRole('CUSTOMER')")
